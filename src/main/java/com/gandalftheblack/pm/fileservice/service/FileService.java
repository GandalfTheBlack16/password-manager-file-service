...
public class FileService {
    ...
    public MultipleFilePostResponse uploadFile(List<MultipartFile> multipartFileList, String userId) throws IOException {
        ...
        for (MultipartFile multipartFile : multipartFileList) {
            ...
            filePostResponses.add(fileMetadataMapper.entityToResponse(fileMetadataRepository.save(fileMetadataEntity)));
        }
        return new MultipleFilePostResponse(filePostResponses);
    }

    private File transformMultipartFile (MultipartFile file) throws IOException {
