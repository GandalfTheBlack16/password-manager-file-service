...
public class CustomFileMetadataRepositoryImpl implements CustomFileMetadataRepository {
  ...
  private static final String COLLECTION_NAME = "fileMetadata";

  @Override
  public Page<FileGetResponse> findAllByOwnerFilteredByStatusAndName(
    ...
    Aggregation aggregation =
        Aggregation.newAggregation(matchOperation, sortOperation, skipOperation, limitOperation);
    List<FileGetResponse> results =
        mongoTemplate
            .aggregate(aggregation, COLLECTION_NAME, FileGetResponse.class)
            .getMappedResults();
