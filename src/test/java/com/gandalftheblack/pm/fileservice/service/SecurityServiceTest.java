...
class SecurityServiceTest {
  ...
  private static final String SECRET =
      "caa288691c0e008d66eb44e6c3dc6d5280660ea8cb6d249c449d3750cb54d260";
  ...
  void shouldReturnUserIdAfterVerifyingTokenAndFindUserInDatabase() {
    ...
    String authHeader =
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImU1ZTI4ZjBlLTE2ZjItNGIxMy04ZTMzLWVlOD"
    ...
    when(userRepository.findUserByEmail(expectedEmail))
        .thenReturn(Optional.of(UserEntity.builder().id("1").build()));
    assertDoesNotThrow(
        () -> {
  ...
  void shouldThrowExceptionIfUserDoesNotExists() {
    ...
    assertThrows(
        UnauthenticatedUserException.class, () -> securityService.getUserIdFromToken(authHeader));
  }
}
